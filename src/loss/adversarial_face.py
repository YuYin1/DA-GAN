...
from loss import discriminator_face
...
class Adversarial_face(nn.Module):
    def __init__(self, args, gan_type):
        super(Adversarial_face, self).__init__()
        self.gan_k = args.gan_k
        self.dis = discriminator_face.Discriminator_face(args)
        optim_dict = {
            'optimizer': 'ADAM',
            'betas': (0, 0.9),
            'epsilon': 1e-8,
